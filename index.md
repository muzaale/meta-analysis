...
## I. Who does [meta-analysis](https://ukubona-llc.github.io/repo-01/)? (And why it feels priestly)

Your instinct is not cranky; it’s structural.

Meta-analysis is typically done by people who:

* arrive **after** primary data collection,
* operate **above** individual study constraints,
* arbitrate *meaning* rather than *measurement*.

That’s why “priests” is not an insult — it’s a role description.

### Why [Al Sommer’s](https://en.wikipedia.org/wiki/Alfred_Sommer) refusal tracks

Sommer comes out of a tradition where:

* **hypothesis formulation precedes aggregation**
* **study design is sacred**
* **measurement error is confronted, not averaged away**
* **causality is earned, not inferred by volume**
...
* substitutes **quantity for rigor**
* treats heterogeneity as noise instead of signal
* confuses *precision* with *truth*
* collapses design failures into confidence intervals

Hence your Plato analogy lands:

> Meta-analysis is the Republic — elegant, totalizing, persuasive —
> and deeply suspicious to anyone who has actually governed a messy polis.
...
I’m not going to summarize the paper.
...
* It attempts to *standardize* what counts as “LKD”
* It reifies obesity as an outcome object rather than a lived trajectory
* It leans heavily on consensus phrasing (“evidence suggests”, “associated with”)

This is already a tell.

Language here is not exploratory — it is **jurisdictional**.
The manuscript wants to say:
...
* variable adherence,
* short and long follow-up horizons,
* mixed metabolic endpoints.
...
The rate of change here is not metabolic.
It’s **discursive**.

The manuscript:

* accelerates legitimacy for LKD
* converts a contested dietary practice into a *trend with velocity*
* creates policy-adjacent momentum

This is art in your calculus sense:

> the shaping of attention and belief over time.

Meta-analysis excels at this.
That’s why it’s seductive.

It doesn’t discover truth.
It **moves the crowd**.
...
* patient phase (newly obese vs lifelong)
* metabolic history
* social context
* sustainability beyond trial windows
...
* freezing a **moment** of dietary enthusiasm into guidance
* ignoring long-term metabolic scars
* mistaking compliance under trial conditions for real life adoption

Cₓ — the residue — is not neutral.

If LKD later disappoints, the scar won’t be “we were cautious.”
It will be:
...
That’s why it feels priestly:
it decides what future regret will look like.
...
It tries to do **Meaning-layer work** with **Science-layer tools**,
while borrowing **Art-layer authority**.
...
> Meta-analysis is what you do when you want closure
> without having paid the full epistemic cost.
